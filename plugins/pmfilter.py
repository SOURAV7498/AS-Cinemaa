    ...
    try:
        ...
        if pm_search:
            ...
            await message.reply_text(
                text=(
                    f"<b>🙋 ʜᴇʏ {user}  ,\n\n"
                    "ʏᴏᴜ ᴄᴀɴ ꜱᴇᴀʀᴄʜ ꜰᴏʀ ᴍᴏᴠɪᴇꜱ ᴇxᴄʟᴜꜱɪᴠᴇʟʏ ɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ. ꜱᴇᴀʀᴄʜɪɴɢ ᴛʜʀᴏᴜɢʜ ᴛʜᴇ ᴅɪʀᴇᴄᴛ ʙᴏᴛ ɪꜱ ɴᴏᴛ ᴀʟʟᴏᴡᴇᴅ. ᴛᴏ ꜰɪɴᴅ ʏᴏᴜʀ ꜰᴀᴠᴏʀɪᴛᴇ ᴍᴏᴠɪᴇꜱ, ꜱɪᴍᴘʟʏ ᴄʟɪᴄᴋ ᴛʜᴇ ʀᴇǫᴜᴇꜱᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ ᴀɴᴅ ᴊᴏɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ.</b>"
