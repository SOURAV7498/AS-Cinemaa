...
auth_channels     = environ.get("AUTH_CHANNELS", "-1002630290227 -100309672279 -1003141475275")# Channels for force sub (make sure bot is admin)
...
MOVIE_UPDATE_CHANNELS = [int(x.strip()) for x in environ.get('MOVIE_UPDATE_CHANNEL', '-1002518211319 -1002748966922 -1002680966673 -1002807798679').split()]  # Notification of sent to your channel
